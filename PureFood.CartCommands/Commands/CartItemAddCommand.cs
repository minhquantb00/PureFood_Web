...
{
    [ProtoContract]
    public record CartItemAddCommand : CartBaseCommand
    {
    ...
    [ProtoContract]
    public record CartItemChangeCommand : CartBaseCommand
    {
        [ProtoMember(1)] public string Id { get; set; }
        [ProtoMember(2)] public string CartId { get; set; }
        [ProtoMember(3)] public string ProductId { get; set; }
    ...
    [ProtoContract]
    public record CartItemRemoveCommand : CartBaseCommand
    {
        [ProtoMember(1)] public string Id { get; set; }
    }
}
